                ...
                return Card(
                  child: Padding(
                    padding: const EdgeInsets.only(
                        top: 36, bottom: 30, left: 9, right: 9),
                    child: Column(
                      children: [
                        Title(
                            color: Colors.black,
                          ...
                          child: Center(
                            child: Column(
                              children: [
                                Text(
                                    " day 1 :   " +
                                        weatherState.data["forecast"][0]
                                                ["temperature"]
                                            .toString()
                                            .replaceAll("Â", "") +
                                        "  |  " +
                                        weatherState.data["forecast"][0]["wind"]
                                            .toString(),
                                    style: const TextStyle(
                                        color: Colors.deepOrange,
                                        fontSize: 18)),
                                ...
                                Text(
                                    " day 3 :   " +
                                        weatherState.data["forecast"][2]
                                                ["temperature"]
                                            .toString()
                                            .replaceAll("Â", "") +
                                        "  |  " +
                                        weatherState.data["forecast"][2]["wind"]
                                            .toString(),
                                    style: const TextStyle(
